 ...
 *
  * - Base URL is Tests/Docker/docker-compose.verify.yml の eccube:80 -> host 8080 (4.2) / 8081 (4.3).
...
export default defineConfig({
  ...
  // webServer: {
  //   command: 'docker compose -f Tests/Docker/docker-compose.verify.yml up -d --build',
